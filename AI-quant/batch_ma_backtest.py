...
chart2.setOption({
    ...
    yAxis: [
        ...
        { type: 'value', name: '夏普比率', alignTicks: true, axisLabel: { formatter: function(v){return v.toFixed(2);} } }
    ],
    series: [
        ...
        { name: '平均夏普比率', type: 'line', yAxisIndex: 1, data: c2Sharpes, lineStyle: { color: '#fac858', width: 2 }, itemStyle: { color: '#fac858' }, label: { show: true, position: 'right', formatter: function(p){return p.value.toFixed(2);}, backgroundColor: '#fff', padding: [2, 4], borderRadius: 3 } }
    ]
});
