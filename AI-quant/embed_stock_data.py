...
new_html = new_html.replace(
    '<option value="159562.SZ">华夏黄金ETF(159562.SZ)</option>\n            <option value="563020.SH">易方达红利低波ETF(563020.SH)</option>',
