    ...
    <div class="container">
        ...
        <div class="chart-section">
            ...
            <div class="strategy-rule">
                ...
                <strong>第四步：交易执行</strong> — 收到信号后，次日开盘执行交易。买入时用50%现金，按开盘价×1.0001（含滑点）计算可买数量，取整到100股；卖出时清空全部持仓，按开盘价×0.9999（含滑点）计算成交价。<br>
            ...
            <table class="params-table">
                ...
                <tr><td><strong>仓位比例</strong></td><td>POSITION_RATIO%（每次买入使用50%现金）</td></tr>
