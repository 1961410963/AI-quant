    ...
    <script>
        ...
        klineChart.setOption({{
            ...
            series: [
                ...
                {{type: 'line', name: 'MA5', data: ma5, smooth: true, symbol: 'circle', symbolSize: 5, lineStyle: {{width: 2, color: '#eab308'}}, itemStyle: {{color: '#eab308'}}}},
                {{type: 'line', name: 'MA10', data: ma10, smooth: true, symbol: 'circle', symbolSize: 5, lineStyle: {{width: 2, color: '#f97316'}}, itemStyle: {{color: '#f97316'}}}},
                {{type: 'line', name: 'MA20', data: ma20, smooth: true, symbol: 'circle', symbolSize: 5, lineStyle: {{width: 2, color: '#22c55e'}}, itemStyle: {{color: '#22c55e'}}}},
                {{type: 'line', name: 'MA60', data: ma60, smooth: true, symbol: 'circle', symbolSize: 5, lineStyle: {{width: 2, color: '#8b5cf6'}}, itemStyle: {{color: '#8b5cf6'}}}}
            ]
        }});
        ...
        macdChart.setOption({{
            ...
            series: [
                ...
                {{type: 'line', name: 'DEA', data: dea, symbol: 'circle', symbolSize: 5, lineStyle: {{width: 2, color: '#3b82f6'}}, itemStyle: {{color: '#3b82f6'}}}},
                {{type: 'bar', name: 'MACD', data: macdBar.map(v => ({{value: v, itemStyle: {{color: v >= 0 ? '#ef4444' : '#22c55e'}}}}))}}
            ]
        }});
        ...
        rsiChart.setOption({{
            ...
            series: [
                ...
                {{type: 'line', name: '70', data: dates.map(() => 70), symbol: 'none', lineStyle: {{width: 1, type: 'dashed', color: '#ef4444'}}}},
                {{type: 'line', name: '30', data: dates.map(() => 30), symbol: 'none', lineStyle: {{width: 1, type: 'dashed', color: '#22c55e'}}}}
            ]
        }});
        ...
        kdjChart.setOption({{
            ...
            series: [
                ...
                {{type: 'line', name: 'D', data: dLine, symbol: 'circle', symbolSize: 5, lineStyle: {{width: 2, color: '#3b82f6'}}, itemStyle: {{color: '#3b82f6'}}}},
                {{type: 'line', name: 'J', data: jLine, symbol: 'circle', symbolSize: 5, lineStyle: {{width: 2, color: '#ec4899'}}, itemStyle: {{color: '#ec4899'}}}}
            ]
        }});
        ...
        bollChart.setOption({{
            ...
            series: [
                ...
                {{type: 'line', name: '上轨', data: upperBoll, symbol: 'circle', symbolSize: 5, lineStyle: {{width: 2, color: '#ef4444', type: 'dashed'}}, itemStyle: {{color: '#ef4444'}}}},
                {{type: 'line', name: '中轨', data: midBoll, symbol: 'circle', symbolSize: 5, lineStyle: {{width: 2, color: '#f97316'}}, itemStyle: {{color: '#f97316'}}}},
                {{type: 'line', name: '下轨', data: lowerBoll, symbol: 'circle', symbolSize: 5, lineStyle: {{width: 2, color: '#22c55e', type: 'dashed'}}, itemStyle: {{color: '#22c55e'}}}}
            ]
        }});
        ...
        atrChart.setOption({{
            ...
            series: [
                ...
                {{type: 'line', name: 'ATR', data: atr, symbol: 'circle', symbolSize: 5, lineStyle: {{width: 2, color: '#8b5cf6'}}, itemStyle: {{color: '#8b5cf6'}}}}
            ]
        }});
